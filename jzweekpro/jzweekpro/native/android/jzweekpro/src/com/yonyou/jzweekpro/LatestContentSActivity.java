...
public abstract class LatestContentSActivity extends UMWindowActivity {

	protected UMWindow LatestContentS = null;
...
protected final static int ID_WEBVIEW0 = 1682679464;
	...
	public String getControllerName() {
		return "LatestContentSController";
	}
...
super.setContentView(currentPage);
	...
	private void registerControl() {
		  idmap.put("LatestContentS",ID_LATESTCONTENTS);
  ...
  idmap.put("webview0",ID_WEBVIEW0);
    ...
    UMEventArgs args = new UMEventArgs(LatestContentSActivity.this);
...
LatestContentS = (UMWindow)ThirdControl.createControl(new UMWindow(context),ID_LATESTCONTENTS
,"halign","center"
,"height","fill"
,"layout-type","linear"
,"layout","vbox"
,"width","fill"
,"controller","LatestContentSController"
,"valign","TOP"
,"namespace","com.yonyou.jzweekpro"
);
View viewPage0 = (View) getViewPage0View((UMActivity)context,binderGroup);
LatestContentS.addView(viewPage0);

return (UMWindow)LatestContentS;
}
  ...
  this.getContainer().exec(actionid, "this.backLatestList()",UMActivity.getViewId(control),args);
}
public void actionBacklastest(View control, UMEventArgs args) {
    String actionid = "backlastest";
    args.put("viewid","com.yonyou.jzweekpro.LatestReadList");
